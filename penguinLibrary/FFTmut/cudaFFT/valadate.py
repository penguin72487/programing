...
def main():
    ...
    with open('C:\\gitproject\\programing\\penguinLibrary\\FFTmut\\cudaFFT\\bumA.txt', 'r') as infile:
    ...
    output_path = 'C:\\gitproject\\programing\\penguinLibrary\\FFTmut\\cudaFFT\\cudaFFToutput.txt'
